...
def print_context_summary(context):
    ...
    print("USER PROJECT")
    print("="*90)
    print(json.dumps(context["user_project"], ensure_ascii=False, indent=2))

    print("\n" + "="*90)
    print("SEMANTIC POSITION")
    print("="*90)
    print(json.dumps(context["semantic_position"], ensure_ascii=False, indent=2))

    print("\n" + "="*90)
    print("KEYWORDS DETECTED")
    print("="*90)
    print(json.dumps(context.get("keywords_detected", []), ensure_ascii=False, indent=2))

    print("\n" + "="*90)
    print("TEMPORAL PATTERNS")
    print("="*90)
    print(json.dumps(context.get("temporal_patterns", {}), ensure_ascii=False, indent=2))

    print("\n" + "="*90)
    print("BRIDGE CLUSTERS")
    print("="*90)
    print(json.dumps(context.get("bridge_clusters", []), ensure_ascii=False, indent=2))

    print("\n" + "="*90)
    print("TOP 10 SIMILAR THESES")
    print("="*90)
    ...
    print("\n" + "="*90)
    print("BIBLIOGRAPHY POOL")
    print("="*90)
    print(json.dumps(context["bibliography_pool"], ensure_ascii=False, indent=2))

    print("\n" + "="*90)
    print("ADVISOR CANDIDATES")
    print("="*90)
    print(json.dumps(context["advisor_candidates"][:8], ensure_ascii=False, indent=2))

    print("\n" + "="*90)
    print("NOVELTY SIGNALS")
    print("="*90)
