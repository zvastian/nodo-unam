...
OUT = Path("base6_homogeneizada_stream_v3.parquet")

OUT_DIR = Path("outputs/base6_homologacion")
OUT_DIR.mkdir(parents=True, exist_ok=True)

FREQ = OUT_DIR / "base6_homogeneizada_stream_v3_autores_freq.csv"
SAMPLE = OUT_DIR / "base6_homogeneizada_stream_v3_author_sample.csv"
LOG = OUT_DIR / "base6_homogeneizada_stream_v3_author_log.csv"
